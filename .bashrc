...
# Someday I will create a "some_command" that prints a image to the stdout as pixelart or something
# alias bb='fd ".*\.[png|jpg|jpeg]" "$HOME/Pictures/anime/" | fzf --algo=v1 --delimiter / --with-nth -1 --preview="some_command {}"'
alias bg='changebg'
